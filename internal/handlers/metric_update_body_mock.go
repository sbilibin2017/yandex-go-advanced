...
// Source: /home/sergey/Go/yandex-go-advanced/internal/handlers/metric_update_body.go
...
func (m *MockMetricUpdaterBody) Update(ctx context.Context, metrics []*types.Metrics) ([]*types.Metrics, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMetricUpdaterBodyMockRecorder) Update(ctx, metrics interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockMetricUpdaterBody)(nil).Update), ctx, metrics)
}
